        ...
        <div class="flex-1 flex flex-col items-center py-10">
            <div class="w-full max-w-5xl">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-semibold text-[#222] mb-2">Search Event Add-Ons</h2>
                ...
                <!-- Search Bar -->
                <form class="relative w-full max-w-md mx-auto" method="GET"
                    action="{{ route('event-addon.index') }}">
