...
<div class="min-h-screen bg-yellow-50 flex items-center justify-center py-10">
    <div class="bg-white rounded-lg shadow p-8 w-full max-w-md">
        ...
        @endif
        <form method="POST" action="{{ url('event-packages') }}" class="space-y-4">
            @csrf
            <div>
            ...
            <div class="flex justify-end gap-2">
                ...
                <button type="submit" class="px-4 py-2 rounded bg-yellow-400 hover:bg-yellow-500 text-yellow-900 font-semibold">Save</button>
            </div>
        </form>
    </div>
</div>
