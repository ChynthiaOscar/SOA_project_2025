...
<div class="min-h-screen bg-[#1E1E1E] flex items-center justify-center px-4 py-16">
    <div class="w-full max-w-4xl bg-[#65090D] rounded-2xl shadow-2xl border border-[#A67D44] p-8 md:p-12 text-white">
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $member->email) }}"
                            class="w-full px-5 py-3 bg-white text-[#65090D] border-2 border-[#A67D44] rounded-md focus:outline-none focus:ring-2 focus:ring-[#E2BB4D] text-lg"
                            required>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-end mt-10">
                        <a href="{{ url()->previous() }}"
                            class="bg-white text-[#65090D] hover:bg-gray-100 font-semibold px-6 py-3 border-2 border-[#A67D44] rounded-full transition text-sm sm:text-base">
                            Batal
                        </a>
                        <button type="submit"
                            class="bg-[#E2BB4D] text-[#65090D] hover:bg-yellow-600 hover:text-white font-bold px-6 py-3 border-2 border-[#A67D44] rounded-full transition text-sm sm:text-base">
                            Simpan
                        </button>
                    </div>
                </form>
