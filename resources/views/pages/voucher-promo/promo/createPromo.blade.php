{{-- filepath: resources/views/pages/voucher-promo/promo/createPromo.blade.php --}}
...
<div class="min-h-screen bg-[#EEEACB] flex items-center justify-center py-10">
    <div class="w-full max-w-xl bg-white border-2 border-[#E2BB4D] p-8 shadow" style="box-shadow:0 4px 16px #e2bb4d33;">
        <h2 class="text-2xl font-bold mb-6 text-black uppercase tracking-wider border-b-2 border-[#E2BB4D] pb-2">Tambah Promo</h2>
        ...
        @endif
        <form method="POST" action="{{ url('/promo/store') }}" class="space-y-5">
            @csrf
            <div>
