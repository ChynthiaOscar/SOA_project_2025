{{-- filepath: resources/views/pages/voucher-promo/promo/editPromo.blade.php --}}
...
<div class="min-h-screen bg-[#EEEACB] flex items-center justify-center py-10">
    <div class="w-full max-w-xl rounded-lg p-8 shadow-lg" style="background-color: #f5edcc;">
        ...
        <h2 class="text-2xl font-bold mb-8 text-black text-center uppercase tracking-wider">Edit Promo</h2>
        @if(session('success'))
