    ...
    <div class="bg-[#FDF2D0] shadow-xl rounded-lg p-6 md:p-8 max-w-2xl mx-auto">
        ...
        <form action="{{ route('inventory.update', $item->inventoryItem_id) }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end pt-4">
                <button type="submit" class="bg-[#A88A29] hover:bg-[#7D661C] text-black font-semibold py-2 px-6 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#A88A29] focus:ring-offset-[#FDF2D0]">Update Item</button>
            </div>
        </form>
    </div>
</div>
