...
<div class="min-h-screen bg-[#EEEACB]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
        @include('pages.service-menu.partials.menu-admin-card', [
            ...
            'name' => 'Mongolian Beef',
            'description' => 'a sweet and savory stir-fry with tender beef and a rich soy-based sauce, combined with a variety of delicately-picked vegetables freshly delivered every morning from a local farm, served on our most exquisite utensils and by our best staffs',
            'price' => '175'
        ])
        @include('pages.service-menu.partials.menu-admin-card', [
            'image' => asset('images/service-menu/mongolian-beef.png'),
    ...
    <a href="{{ url('/add_menu') }}" class="fixed bottom-6 right-6 bg-[#65090D] text-white hover:bg-[#8b121b] shadow-lg rounded-full p-4 flex items-center justify-center transition duration-300" title="Add Menu">
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#E2BB4D"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
    </a>
