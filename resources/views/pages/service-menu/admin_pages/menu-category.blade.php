...
@section('content')
    <div class="min-h-screen bg-[#EEEACB]">
        ...
        <div class="grid grid-cols-4 gap-y-6 gap-x-2 p-12 justify-items-center">
            ...
            <div onclick="openModal()"
                class="p-2 bg-[#EEEACB] border-2 border-[#65090D] w-64 cursor-pointer shadow-lg hover:shadow-2xl transition duration-300 align-items-center justify-center self-center align-self-center">
                <div class="px-8 py-1 border-2 border-dashed border-[#A67D44]">
                    ...
                    <svg class="justify-self-center mt-1 mb-2 mx-auto" xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#65090D">
    ...
    {{-- MODAL --}}
    <div id="categoryModal" class="fixed inset-0 z-50 items-center justify-center bg-black bg-opacity-50 hidden">
            ...
            <form id="categoryForm" action="{{ route('store.category') }}" method="POST">
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" onclick="closeModal()"
                        class="px-4 py-2 border rounded bg-gray-300 hover:bg-gray-400">Cancel</button>
                    <button type="submit"
                        class="px-4 py-2 bg-[#E2BB4D] text-[#65090D] rounded hover:bg-[#A67D44]">Add</button>
                </div>
            </form>
        </div>
    </div>
