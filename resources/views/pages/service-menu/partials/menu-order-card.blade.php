<div class="p-3 bg-[#65090D] border-4 border-[#65090D] w-80">
    <div class="px-3 py-2 border-4 border-[#A67D44]">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 justify-items-between mt-4">
                    ...
                    <a class="bg-[#E4C788] px-2 py-2 rounded-full hover:bg-[#A67D44] transition duration-300 justify-self-end w-fit cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#65090D"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
                    </a>
                </div>  
