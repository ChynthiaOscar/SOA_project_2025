<div class="bg-[#E2BB4D] border-2 border-[#65090D] shadow-md flex w-full relative min-h-[10rem]">
    ...
    <div class="p-4 flex flex-col justify-between flex-grow">
        ...
        <div class="flex items-center justify-between mt-2">
            ...
            <button onclick="openDeleteMenuPopup('{{ $name }}')" title="Delete Menu">
...
<div id="modalBackdrop" class="fixed inset-0 bg-black bg-opacity-50 hidden flex justify-center items-center z-50">
    <div id="deleteMenuPopup" class="bg-white rounded-lg shadow-xl p-6 max-w-md w-full text-center">
        ...
        <div class="flex justify-center gap-4">
            ...
            <button onclick="confirmMenuDelete()" class="px-4 py-2 rounded bg-red-600 text-white hover:bg-red-700">Delete</button>
        </div>
    </div>
</div>
...
<script>
    ...
    function openDeleteMenuPopup(menuName) {
    ...
    function confirmMenuDelete() {
        alert(`Menu "${currentMenuName}" has been successfully deleted.`);
        closeDeletePopup();
    }
</script>
